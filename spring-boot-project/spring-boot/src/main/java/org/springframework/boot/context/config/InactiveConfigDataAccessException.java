...
public class InactiveConfigDataAccessException extends ConfigDataException {
     ...
     */
    InactiveConfigDataAccessException(PropertySource<?> propertySource, ConfigDataResource location, String propertyName, @Nullable Origin origin) {
    ...
    private static String getMessage(PropertySource<?> propertySource, ConfigDataResource location, String propertyName, @Nullable Origin origin) {
