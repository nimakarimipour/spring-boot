...
public class InvalidConfigDataPropertyException extends ConfigDataException {
    ...
    InvalidConfigDataPropertyException(ConfigurationProperty property, ConfigurationPropertyName replacement, @Nullable ConfigDataResource location) {
    ...
    private static String getMessage(ConfigurationProperty property, ConfigurationPropertyName replacement, @Nullable ConfigDataResource location) {
