...
public class InvalidConfigDataPropertyException extends ConfigDataException {
    ...
    InvalidConfigDataPropertyException(@Nullable ConfigurationProperty property, ConfigurationPropertyName replacement, @Nullable ConfigDataResource location) {
    ...
    private static String getMessage(@Nullable ConfigurationProperty property, ConfigurationPropertyName replacement, @Nullable ConfigDataResource location) {
