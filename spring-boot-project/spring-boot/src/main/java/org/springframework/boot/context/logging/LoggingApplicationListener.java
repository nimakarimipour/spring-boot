...
public class LoggingApplicationListener implements GenericApplicationListener {
	...
	@Nullable private static final ConfigurationPropertyName LOGGING_LEVEL = ConfigurationPropertyName.of("logging.level");

	@Nullable private static final ConfigurationPropertyName LOGGING_GROUP = ConfigurationPropertyName.of("logging.group");
	...
	@NullUnmarked private void initializeSystem(ConfigurableEnvironment environment, @Nullable LoggingSystem system, @Nullable LogFile logFile) {
