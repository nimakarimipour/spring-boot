...
public final class ConfigurationPropertiesBean {
    ...
    private static ConfigurationPropertiesBean create(String name, Object instance, Class<?> type, @Nullable Method factory) {
    ...
    @Nullable
    private static <A extends Annotation> A findAnnotation(Object instance, Class<?> type, @Nullable Method factory, Class<A> annotationType) {
