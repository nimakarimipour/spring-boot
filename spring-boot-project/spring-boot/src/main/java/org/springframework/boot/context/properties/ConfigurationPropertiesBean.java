...
public final class ConfigurationPropertiesBean {
    ...
    private ConfigurationPropertiesBean(String name, @Nullable Object instance, ConfigurationProperties annotation, Bindable<?> bindable) {
        this(name, instance, annotation, bindable, BindMethod.get(bindable));
    }

    private ConfigurationPropertiesBean(String name, @Nullable Object instance, ConfigurationProperties annotation, Bindable<?> bindTarget, BindMethod bindMethod) {
        this.name = name;
