...
class PropertySourcesDeducer {
	...
	@NullUnmarked @Nullable private PropertySourcesPlaceholderConfigurer getSinglePropertySourcesPlaceholderConfigurer() {
	...
	@NullUnmarked @Nullable private MutablePropertySources extractEnvironmentPropertySources() {
