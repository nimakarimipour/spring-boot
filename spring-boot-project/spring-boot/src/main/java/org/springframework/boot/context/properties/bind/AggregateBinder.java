...
abstract class AggregateBinder<T> {
    ...
    @Nullable
    final Object bind(@Nullable ConfigurationPropertyName name, Bindable<?> target, AggregateElementBinder elementBinder) {
     ...
     */
    @Nullable
    protected abstract Object bindAggregate(@Nullable ConfigurationPropertyName name, Bindable<?> target, AggregateElementBinder elementBinder);
