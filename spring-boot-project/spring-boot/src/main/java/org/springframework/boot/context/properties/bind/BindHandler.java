...
public interface BindHandler {
     ...
     */
    @Nullable
    default Object onCreate(@Nullable ConfigurationPropertyName name, Bindable<?> target, BindContext context, @Nullable Object result) {
        return result;
    }
     ...
     */
    @Nullable
    default Object onFailure(@Nullable ConfigurationPropertyName name, Bindable<?> target, BindContext context, Exception error) throws Exception {
        throw error;
    }
     ...
     * @throws Exception if the binding isn't valid
     */
    default void onFinish(@Nullable ConfigurationPropertyName name, Bindable<?> target, BindContext context, @Nullable Object result) throws Exception {
    }
}
