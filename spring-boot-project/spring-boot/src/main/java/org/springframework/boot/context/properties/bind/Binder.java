...
public class Binder {
	 ...
	 */
	@Nullable public <T> T bindOrCreate(String name, Bindable<T> target) {
	 ...
	 * @see #bindOrCreate(ConfigurationPropertyName, Bindable, BindHandler)
	 */
	@Nullable public <T> T bindOrCreate(String name, Bindable<T> target, BindHandler handler) {
	 ...
	 * @since 2.2.0
	 */
	@Nullable public <T> T bindOrCreate(@Nullable ConfigurationPropertyName name, Bindable<T> target, @Nullable BindHandler handler) {
		return bind(name, target, handler, true);
	}

	@Nullable private <T> T bind(@Nullable ConfigurationPropertyName name, Bindable<T> target, @Nullable BindHandler handler, boolean create) {
	...
	@Nullable private <T> T bind(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler, Context context,
	...
	@Nullable private <T> T handleBindResult(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler,
	...
	@Nullable private Object create(Bindable<?> target, Context context) {
	...
	@Nullable private <T> T handleBindError(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler,
	...
	@Nullable private <T> Object bindObject(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler,
	...
	@Nullable private AggregateBinder<?> getAggregateBinder(Bindable<?> target, Context context) {
	...
	private <T> Object bindAggregate(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler,
	...
	@NullUnmarked @Nullable private <T> ConfigurationProperty findProperty(@Nullable ConfigurationPropertyName name, Bindable<T> target,
			Context context) {
	...
	@NullUnmarked @Nullable private Object bindDataObject(@Nullable ConfigurationPropertyName name, Bindable<?> target, BindHandler handler,
			Context context, boolean allowRecursiveBinding) {
	...
	final class Context implements BindContext {
		...
		@Nullable private ConfigurationProperty configurationProperty;
