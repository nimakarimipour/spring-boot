...
public class Binder {
	...
	private <T> Object bindAggregate(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler,
	 ...
	 @Nullable private <T> ConfigurationProperty findProperty(@Nullable ConfigurationPropertyName name, Bindable<T> target,
			Context context) {
	...
	@Nullable private <T> Object bindProperty(Bindable<T> target, Context context, ConfigurationProperty property) {
	 ...
	 @Nullable private Object bindDataObject(@Nullable ConfigurationPropertyName name, Bindable<?> target, BindHandler handler,
			Context context, boolean allowRecursiveBinding) {
