...
public class Binder {
     ...
     */
    public Binder(Iterable<ConfigurationPropertySource> sources, @Nullable PlaceholdersResolver placeholdersResolver, @Nullable ConversionService conversionService, @Nullable Consumer<PropertyEditorRegistry> propertyEditorInitializer) {
     ...
     * @since 2.2.0
     */
    public Binder(Iterable<ConfigurationPropertySource> sources, @Nullable PlaceholdersResolver placeholdersResolver, @Nullable ConversionService conversionService, @Nullable Consumer<PropertyEditorRegistry> propertyEditorInitializer, @Nullable BindHandler defaultBindHandler) {
     ...
     */
    @Nullable
    public <T> T bindOrCreate(@Nullable ConfigurationPropertyName name, Bindable<T> target, @Nullable BindHandler handler) {
        return bind(name, target, handler, true);
    }

    @Nullable
    private <T> T bind(@Nullable ConfigurationPropertyName name, Bindable<T> target, @Nullable BindHandler handler, boolean create) {
    ...
    @Nullable
    private <T> T bind(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler, Context context, boolean allowRecursiveBinding, boolean create) {
        try {
    ...
    @Nullable
    private <T> T handleBindResult(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler, Context context, @Nullable Object result, boolean create) throws Exception {
        if (result != null) {
    ...
    @Nullable
    private <T> T handleBindError(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler, Context context, Exception error) {
        try {
    ...
    @Nullable
    private <T> Object bindObject(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler, Context context, boolean allowRecursiveBinding) {
    ...
    private <T> Object bindAggregate(@Nullable ConfigurationPropertyName name, Bindable<T> target, BindHandler handler, Context context, AggregateBinder<?> aggregateBinder) {
    ...
    @Nullable
    private ConfigurationProperty findProperty(@Nullable ConfigurationPropertyName name, Context context) {
        if (name.isEmpty()) {
            return null;
        }
    ...
    @Nullable
    private Object bindDataObject(@Nullable ConfigurationPropertyName name, Bindable<?> target, BindHandler handler, Context context, boolean allowRecursiveBinding) {
    ...
    private boolean isUnbindableBean(@Nullable ConfigurationPropertyName name, Bindable<?> target, Context context) {
        for (ConfigurationPropertySource source : context.getSources()) {
    ...
    private boolean containsNoDescendantOf(Iterable<ConfigurationPropertySource> sources, @Nullable ConfigurationPropertyName name) {
