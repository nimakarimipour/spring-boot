...
public class ValidationBindHandler extends AbstractBindHandler {
    ...
    @Override
    public void onFinish(@Nullable ConfigurationPropertyName name, Bindable<?> target, BindContext context, @Nullable Object result) throws Exception {
        validate(name, target, context, result);
        super.onFinish(name, target, context, result);
    }

    private void validate(@Nullable ConfigurationPropertyName name, Bindable<?> target, BindContext context, @Nullable Object result) {
    ...
    private void validateAndPush(@Nullable ConfigurationPropertyName name, Object target, Class<?> type) {
    ...
    private class ValidationResult extends AbstractBindingResult {
        ...
        protected ValidationResult(@Nullable ConfigurationPropertyName name, Object target) {
            super(null);
            this.name = name;
            this.target = target;
        }
        ...
        ValidationErrors getValidationErrors() {
            Set<ConfigurationProperty> boundProperties = ValidationBindHandler.this.boundProperties.stream().filter((property) -> this.name.isAncestorOf(property.getName())).collect(Collectors.toCollection(LinkedHashSet::new));
