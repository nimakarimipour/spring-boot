...
public class ValidationErrors implements Iterable<ObjectError> {
    ...
    ValidationErrors(@Nullable ConfigurationPropertyName name, Set<ConfigurationProperty> boundProperties, List<ObjectError> errors) {
    ...
    private List<ObjectError> convertErrors(@Nullable ConfigurationPropertyName name, Set<ConfigurationProperty> boundProperties, List<ObjectError> errors) {
    ...
    private ObjectError convertError(@Nullable ConfigurationPropertyName name, Set<ConfigurationProperty> boundProperties, ObjectError error) {
    ...
    private FieldError convertFieldError(@Nullable ConfigurationPropertyName name, Set<ConfigurationProperty> boundProperties, FieldError error) {
    ...
    @Nullable
    private Origin findFieldErrorOrigin(@Nullable ConfigurationPropertyName name, Set<ConfigurationProperty> boundProperties, FieldError error) {
    ...
    private boolean isForError(@Nullable ConfigurationPropertyName name, ConfigurationPropertyName boundPropertyName, FieldError error) {
        return name.isParentOf(boundPropertyName) && boundPropertyName.getLastElement(Form.UNIFORM).equalsIgnoreCase(error.getField());
    }
