...
public final class ConfigurationProperty implements OriginProvider, Comparable<ConfigurationProperty> {
    ...
    @Nullable
    static ConfigurationProperty of(@Nullable ConfigurationPropertySource source, @Nullable ConfigurationPropertyName name, Object value, @Nullable Origin origin) {
        if (value == null) {
            return null;
        }
