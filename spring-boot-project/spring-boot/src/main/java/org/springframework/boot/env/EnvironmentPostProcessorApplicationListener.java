...
public class EnvironmentPostProcessorApplicationListener implements SmartApplicationListener, Ordered {
    ...
    EnvironmentPostProcessorApplicationListener(EnvironmentPostProcessorsFactory postProcessorsFactory, DeferredLogs deferredLogs) {
    ...
    List<EnvironmentPostProcessor> getEnvironmentPostProcessors(@Nullable ConfigurableBootstrapContext bootstrapContext) {
