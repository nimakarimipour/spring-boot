...
public enum DatabaseDriver {
    ...
    DatabaseDriver(String productName, String driverClassName, @Nullable String xaDataSourceClassName) {
        this(productName, driverClassName, xaDataSourceClassName, null);
    }

    DatabaseDriver(String productName, String driverClassName, @Nullable String xaDataSourceClassName, @Nullable String validationQuery) {
