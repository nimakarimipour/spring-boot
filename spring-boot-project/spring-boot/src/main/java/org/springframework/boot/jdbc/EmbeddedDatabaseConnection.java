...
public enum EmbeddedDatabaseConnection {
     ...
     */
    @Deprecated
    HSQL(EmbeddedDatabaseType.HSQL, DatabaseDriver.HSQLDB.getDriverClassName(), "org.hsqldb.jdbcDriver", "jdbc:hsqldb:mem:%s", (url) -> url.contains(":hsqldb:mem:")),
    /**
     * HSQL Database Connection.
     * @since 2.4.0
     */
    ...
    EmbeddedDatabaseConnection(@Nullable EmbeddedDatabaseType type, @Nullable String driverClass, @Nullable String url, Predicate<String> embeddedUrl) {
        this(type, driverClass, null, url, embeddedUrl);
    }

    EmbeddedDatabaseConnection(@Nullable EmbeddedDatabaseType type, @Nullable String driverClass, @Nullable String fallbackDriverClass, @Nullable String url, Predicate<String> embeddedUrl) {
        this.type = type;
