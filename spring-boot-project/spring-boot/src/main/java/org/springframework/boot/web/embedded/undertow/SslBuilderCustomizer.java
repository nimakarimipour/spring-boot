...
class SslBuilderCustomizer implements UndertowBuilderCustomizer {
	...
	SslBuilderCustomizer(int port, @Nullable InetAddress address, Ssl ssl,
	...
	private KeyManager[] getKeyManagers(Ssl ssl, @Nullable SslStoreProvider sslStoreProvider) {
		try {
	...
	private TrustManager[] getTrustManagers(Ssl ssl, @Nullable SslStoreProvider sslStoreProvider) {
		try {
	...
	private KeyStore loadKeyStore(@Nullable String type, @Nullable String provider, @Nullable String resource,
			@Nullable String password) throws Exception {
		return loadStore(type, provider, resource, password);
	}

	@Nullable
	private KeyStore loadTrustStore(@Nullable String type, @Nullable String provider, @Nullable String resource,
			@Nullable String password) throws Exception {
		if (resource == null) {
			return null;
		}
	...
	private KeyStore loadStore(@Nullable String type, @Nullable String provider, @Nullable String resource,
			@Nullable String password) throws Exception {
