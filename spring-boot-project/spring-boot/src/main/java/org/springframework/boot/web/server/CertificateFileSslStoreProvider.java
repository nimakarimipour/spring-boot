...
public final class CertificateFileSslStoreProvider implements SslStoreProvider {
    ...
    private void addCertificates(KeyStore keyStore, X509Certificate[] certificates, @Nullable PrivateKey privateKey, @Nullable String keyAlias) throws KeyStoreException {
