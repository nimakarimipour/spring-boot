...
public class MimeMappings implements Iterable<MimeMappings.Mapping> {
    ...
    static final class DefaultMimeMappings extends MimeMappings {
        ...
        private Map<String, Mapping> load() {
            ...
            try {
                ...
                for (Entry<?, ?> entry : PropertiesLoaderUtils.loadProperties(new ClassPathResource(MIME_MAPPINGS_PROPERTIES, getClass())).entrySet()) {
    ...
    static class MimeMappingsRuntimeHints implements RuntimeHintsRegistrar {
        ...
        public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
            hints.resources().registerPattern("org/springframework/boot/web/server/" + DefaultMimeMappings.MIME_MAPPINGS_PROPERTIES);
        }
    }
}
