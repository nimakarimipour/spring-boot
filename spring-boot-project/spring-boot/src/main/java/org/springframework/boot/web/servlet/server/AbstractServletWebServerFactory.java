...
public abstract class AbstractServletWebServerFactory extends AbstractConfigurableWebServerFactory
	 ...
	 */
	@Nullable public File getDocumentRoot() {
	 ...
	 */
	@Nullable protected final File getValidDocumentRoot() {
	...
	private static class SessionConfiguringInitializer implements ServletContextInitializer {
		...
		private void configureSessionCookie(SessionCookieConfig config) {
		 ...
		 @Nullable private Set<jakarta.servlet.SessionTrackingMode> unwrap(Set<Session.SessionTrackingMode> modes) {
			if (modes == null) {
				return null;
			}
